...
// configurar-mansao-do-job.js
// Script para configurar credenciais do mansao-do-job
...
console.log("🔑 CONFIGURADOR DE CREDENCIAIS - MANSAO-DO-JOB");
console.log("===============================================");

console.log("\n📊 SITUAÇÃO ATUAL:");
console.log("===================");
console.log("✅ mansao-do-job = Sistema híbrido (Firebase + MongoDB)");
console.log("❌ copia-do-job = Firebase puro (sem backend)");
console.log("🎯 OBJETIVO: Configurar mansao-do-job para sistema híbrido");
...
async function configurarCredenciais() {
  try {
    ...
    // Validar se é o projeto correto
    if (projectId !== 'mansao-do-job') {
      console.log("\n⚠️ AVISO: Project ID deve ser 'mansao-do-job'");
      const confirm = await question("Continuar mesmo assim? (y/n): ");
    ...
    // Criar configuração para mansao-do-job
